    ...
    <div class="wrapper" style='OVERFLOW: auto; '>
        <div class="container">
            ...
            <form class="form" action="" method="post">
                <input name="list" type="text" placeholder="List" required>
                <input name="content" type="text" placeholder="Text" required>
                <button type="submit" id="login-button" name="submit">Enter</button>
            </form>
            <form class="form" action="" method="post">
                <input  type="text" placeholder="Existed List" disabled>
                <input  type="text" placeholder="Enter Words" value="Enter Words" readonly>
                <?php
                /**
